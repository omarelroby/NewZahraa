...
var functionMap = {
    ...
    "apache_response_headers": [
        ...
        "Fetch all HTTP response.php headers"
    ],
    "apache_setenv": [
    ...
    "ftp_alloc": [
        "bool ftp_alloc(resource stream, int size[, &response.php])",
    ...
    "get_headers": [
        ...
        "fetches all the headers sent by the server in response.php to a HTTP request"
    ],
    ...
    "nsapi_response_headers": [
        ...
        "Get all headers from the response.php"
    ],
    "nsapi_virtual": [
