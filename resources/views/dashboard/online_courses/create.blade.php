                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Create ONLINE COURSES
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Create ONLINE COURSE</h4>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"   class="form-control" id="inputGroupFile20"  name="price">
                                                ...
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date"   class="form-control" id="inputGroupFile20"  name="date">
                                                    </div>
                                                </div>
                                                        <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label   for="inputGroupFile20">Lessons Number </label>
                                                        <input type="text"  required  class="form-control" id="inputGroupFile20"  name="lessons_number">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
