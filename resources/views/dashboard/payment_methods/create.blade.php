                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('dashboard.add-payment-method')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" method="post" action="{{route('payment-method.store')}}" enctype='multipart/form-data'>
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-align-right"></i> {{__('dashboard.add-payment-method')}}</h4>
                                                <div class="row">
                                                    ...
                                                    @foreach(config('translatable.locales') as $locale)
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input required id="projectinput1" class="form-control"   name="{{$locale}}[name]">
                                                             </div>
                                                        </div>
                                                    @endforeach
                                            ...
                                            <div class="form-actions">
                                                <button type="button" class="btn btn-warning mr-1">
                                                    <a href="{{route('payment-method.index')}}" style="color: white"> <i class="ft-x"></i>{{__('dashboard.cancel')}}</a>
                                                </button>
