                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('dashboard.add-section')}}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" method="post" action="{{route('home-section.store')}}" enctype='multipart/form-data'>
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-align-right"></i> {{__('dashboard.home-section')}}</h4>
                                                <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input required id="projectinput1" class="form-control input-custom"   name="{{$locale}}[button]">
