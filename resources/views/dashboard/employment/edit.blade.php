                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('dashboard.edit-employment-applications')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('dashboard.edit-employment-applications')}}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form class="form" autocomplete="off" method="post" action="{{route("employment.update", $employment->id )}}" enctype='multipart/form-data'>
                                            @csrf
                                            {{ method_field('put') }}
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-align-right"></i>{{__('dashboard.instructors')}}</h4>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                {!! $employment->translate($locale)->description !!}
                                                                </textarea>
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                                ...
                                                                {!! $employment->translate($locale)->qualifications !!}
                                                                            </textarea>
                                                                        </div>
                                                                    </div>
                                                                @endforeach
