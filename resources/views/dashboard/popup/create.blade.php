                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('dashboard.add-popup')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('dashboard.add-popup')}}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form class="form" method="post" action="{{route('popup.store')}}" enctype='multipart/form-data'>
                                            @csrf
                                            <input hidden value="{{$id}}" name="home_section_id">
                                            <div class="form-body">
                                                ...
                                                <div class="row align-items-end">
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" required id="projectinput1" class="form-control input-custom"   name="link">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="checkbox" value="active"   class="form-check"     name="status">
                                                        </div>
                                                    </div>
                                                </div>
                                            <div class="form-actions">
                                                <button type="button" class="btn btn-warning mr-1 rounded-10">
                                                    <a href="{{route('popup.index',$id)}}" style="color: white"> <i class="ft-x"></i>{{__('dashboard.cancel')}}</a>
                                                </button>
