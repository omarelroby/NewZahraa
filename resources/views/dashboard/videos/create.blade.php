        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">VIDEOS</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Create VIDEO
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Create VIDEOS</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" method="post" action="{{route('videos.store')}}" enctype='multipart/form-data'>
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-align-right"></i> VIDEOS</h4>
                                                <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label   for="inputGroupFile20">Complete Video </label>
                                                        <input type="file"  required class="form-control" id="inputGroupFile20"  name="complete_video">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="form-actions">
                                                <button type="button" class="btn btn-warning mr-1">
                                                    <a href="{{route('videos.index')}}" style="color: white"> <i class="ft-x"></i>Cancel</a>
                                                </button>
